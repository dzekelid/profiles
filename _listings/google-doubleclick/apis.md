...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/google-doubleclick/apis.md
...
- name: Google Doubleclick Merged API - Get Publish Profiles
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/google-doubleclick/publisheraccountidprofiles-get-openapi.md
- name: Google Doubleclick Merged API - Get Publish Profiles
  x-api-slug: publisheraccountidprofiles-get
  description: Gets the requested publisher profile(s) by publisher accountId.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-double-click.png
