...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/apis.md
...
- name: ThingPark DX Admin API - Profiles Retrieval
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/profiles-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/profiles-get-openapi.md
- name: ThingPark DX Admin API - Profile Retrieval
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/profilesprofileid-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/profilesprofileid-get-openapi.md
- name: ThingPark DX Admin API - Profile Retrieval
  x-api-slug: profilesprofileid-get
  description: Retrieves the profile corresponding to the provided profile Id.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28250-actility.jpg
...
- name: ThingPark DX Core API - Device profiles retrieval
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/deviceprofiles-get-openapi.md
- name: ThingPark DX Core API - Routing profiles retrieval
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/routingprofiles-get-openapi.md
- name: ThingPark DX Core API - Routing profiles creation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/routingprofiles-post-openapi.md
- name: ThingPark DX Core API - Base station profiles retrieval
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/basestationprofiles-get-openapi.md
- name: ThingPark DX Core API - Routing profile retrieval
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/routingprofilesroutingprofileref-get-openapi.md
- name: ThingPark DX Core API - Routing profile update
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/routingprofilesroutingprofileref-put-openapi.md
- name: ThingPark DX Core API - Routing profile deletion
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/profiles/master/_listings/actility/routingprofilesroutingprofileref-delete-openapi.md
- name: ThingPark DX Core API - Routing profile retrieval
  x-api-slug: routingprofilesroutingprofileref-get
  description: Retrieves the routing profile corresponding to the provided routing
    profile ref, if that routing profile is within authorized scopes.
